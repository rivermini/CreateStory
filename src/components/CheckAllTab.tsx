  ...
  return (
    <div className="flex h-full min-h-[400px] flex-col">
      ...
      >
        <div className="relative min-w-0 flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border py-2.5 pl-9 pr-4 text-sm outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
      ...
      <div className="flex-1 p-4">
        ...
        {data && filterSection === 'no_cover' && filteredNoCover.length === 0 && <EmptySection isDark={isDark} message="No folders missing cover1.jpg." />}
