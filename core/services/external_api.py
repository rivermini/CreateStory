"""External API client for the AutoAudio service."""
...
from core.config import _get_external_api_config
...
class ExternalAPIClient:
    ...
    def post(self, path: str, json_data: Optional[dict] = None) -> dict:
        resp = self._request("POST", path, json_data=json_data, timeout=60.0)
        resp.raise_for_status()
        raw = resp.json()
