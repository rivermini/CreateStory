"""Story processing pipeline for the auto-audio service."""
...
class StoryPipeline:
    ...
    def upload_completed_batch(
        ...
        self._cleanup_batch_output(session, batch_id)

    def _cleanup_batch_output(self, session: AutoAudioSession, batch_id: str) -> None:
