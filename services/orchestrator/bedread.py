"""BedRead batch job integration for the auto-audio service."""
...
from .config import _get_bedreadvoices_url, _get_bedreadvoices_output_base
from .models import _CompressedAudio, StoryMissingAudio
...
class BedReadClient:
    ...
    def get_batch_output_dir(self, batch_id: str) -> Optional[Path]:
