"""Upload logic for the auto-audio service — compresses audio and uploads to the main BE."""
...
from .models import _CompressedAudio, AutoAudioSession
...
class UploadManager:
    ...
    def upload_audio(
        ...
        try:
            ...
            self._api.put_with_retry(presigned_url, compressed.data, mime_type, required_headers)
    ...
    def _compress_audio_to_opus(self, session: AutoAudioSession, audio_path: Path) -> _CompressedAudio:
