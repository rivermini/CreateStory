...
if str(PROJECT_ROOT) == "/":
    FASTAPI_SERVER_DIR = Path("/app")
else:
    FASTAPI_SERVER_DIR = PROJECT_ROOT / "FastAPIServer"
...
class TestSecrets:
    ...
    def test_env_file_not_in_git_tracked(self) -> None:
        ...
        env_path = FASTAPI_SERVER_DIR / ".env"
...
class TestDockerfile:
    ...
    DOCKERFILE = FASTAPI_SERVER_DIR / "Dockerfile"
