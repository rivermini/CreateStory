...
_RE_SOURCE_SUFFIX = re.compile(
    r"_(?:wp|gd|Goodnovel|nw|ink|jn|jobnib|sh|scribblehub|nl|novellunar|wn|webnovel|nh|novelhall|rn|readnovelmtl)(?![a-zA-Z0-9_])|_-_?novel(?=\s|_|\s-\s|$)", re.IGNORECASE
)
