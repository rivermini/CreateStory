...
interface CheckUpdatedBannerTabProps {
  ...
  return (
    <div className="flex h-full min-h-[400px] flex-col">
      ...
      <div className="flex-1 p-4">
        {!loading && !data && (
          <EmptyState isDark={isDark} message="Click 'Check Updated Banner' to view all banner update history records." icon={<Icon icon={appIcons.folder} className="h-8 w-8" style={{ color: tertiaryText }} />} />
        )}
...
function HistoryEntryCard({
  ...
  const borderColor = isNoBanner ? (isDark ? 'rgba(239,68,68,0.2)' : 'rgba(239,68,68,0.25)') : panelBorder;
