...
export function getThemeTokens(themeMode: ThemeMode): ThemeTokens {
  ...
  return {
    ...
    isDark,
    colors: {
      page: isDark ? '#212121' : '#ffffff',
      pageSoft: isDark ? '#1c1c1c' : '#ffffff',
      surface: isDark ? 'rgba(43,43,43,0.92)' : 'rgba(255,255,255,0.88)',
      surfaceElevated: isDark ? 'rgba(28,28,28,0.96)' : 'rgba(255,255,255,0.96)',
